...
func TestRaceConditions(t *testing.T) {
	...
	runConcurrentOperation(&wg, testDuration, "add-prompts", func() {
		...
		}, func(ctx context.Context, requestSession RequestSession, req mcp.GetPromptRequest) (*mcp.GetPromptResult, error) {
	...
	runConcurrentOperation(&wg, testDuration, "add-tools", func() {
		...
		}, func(ctx context.Context, requestSession RequestSession, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	...
	runConcurrentOperation(&wg, testDuration, "add-middleware", func() {
		middleware := func(next ToolHandlerFunc) ToolHandlerFunc {
			return func(ctx context.Context, requestSession RequestSession, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
				return next(ctx, requestSession, req)
			}
		}
	...
	runConcurrentOperation(&wg, testDuration, "add-resources", func() {
		...
		}, func(ctx context.Context, requestSession RequestSession, req mcp.ReadResourceRequest) ([]mcp.ResourceContents, error) {
