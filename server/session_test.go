...
func (f sessionTestClient) SetLogLevel(level mcp.LoggingLevel) {
}

func (f sessionTestClient) GetLogLevel() mcp.LoggingLevel {
	return mcp.LoggingLevelError
}

func (f sessionTestClient) GetLoggerName() *string {
	return nil
}
...
func (f *sessionTestClientWithTools) SetLogLevel(level mcp.LoggingLevel) {
}

func (f *sessionTestClientWithTools) GetLogLevel() mcp.LoggingLevel {
	return mcp.LoggingLevelError
}

func (f *sessionTestClientWithTools) GetLoggerName() *string {
	return nil
}
...
func (f *sessionTestClientWithLogging) GetLoggerName() *string {
	return nil
}
...
func TestMCPServer_CallSessionTool(t *testing.T) {
	...
	// Add global tool
	server.AddTool(mcp.NewTool("test_tool"), func(ctx context.Context, reqContext RequestContext, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
