...
func NewMCPServer() *server.MCPServer {
	...
	mcpServer.AddTool(mcp.NewTool(string(GET_AUDIO),
		mcp.WithDescription("Returns the MCP_AUDIO"),
	), handleGetAudioTool)
...
func handleGetAudioTool(
	...
	return &mcp.CallToolResult{
		Content: []mcp.Content{
			...
			mcp.TextContent{
				Type: "text",
				Text: "The audio above is an example audio content.",
			},
		},
	}, nil
}
